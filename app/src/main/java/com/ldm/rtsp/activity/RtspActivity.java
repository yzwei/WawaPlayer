...
public class RtspActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    //边播放边保存到SD卡文件目录
    //private static final String filePath = Environment.getExternalStorageDirectory() + "/result.h264";
    private static final String filePath = "/sdcard/Movies/result.h264";
